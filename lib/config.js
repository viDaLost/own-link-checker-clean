...
export function getConfig() {
  return {
    ...
    cacheMaxEntries: numberFromEnv("CACHE_MAX_ENTRIES", 20000, 10, 100000),
    connectionsPerOrigin: numberFromEnv("HTTP_CONNECTIONS_PER_ORIGIN", 8, 1, 32),
    runsPerMinute: numberFromEnv("RATE_LIMIT_PER_MINUTE", 30, 1, 10000),
    urlsPerMinute: numberFromEnv("URL_RATE_LIMIT_PER_MINUTE", 20000, 1, 100000),
